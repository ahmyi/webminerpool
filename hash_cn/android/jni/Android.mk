...
LOCAL_CPPFLAGS += -pthread -frtti -std=c++11  -Wall -fno-exceptions -fno-rtti -Wno-missing-braces -g -v
LOCAL_CFLAGS   += -Ofast -funroll-loops -fmerge-all-constants -flax-vector-conversions  -g -v
LOCAL_CPPFLAGS += -Ofast -funroll-loops -fmerge-all-constants -flax-vector-conversions
LOCAL_CFLAGS +=   -DXMRIG_NO_HTTPD -DXMRIG_NO_API -DXMRIG_NO_LIBCPUID -DXMRIG_ARM
